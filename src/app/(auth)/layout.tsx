...
export default function AuthLayout({
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center h-full w-full">
      <div className="flex w-full lg:w-1/2 lg:h-full bg-primary flex-col items-center justify-center relative py-10 px-6 text-background dark:text-foreground bg-gradient-to-br from-primary from-40% to-secondary to-[125%]">
